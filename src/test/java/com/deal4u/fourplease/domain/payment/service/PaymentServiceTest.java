...
class PaymentServiceTest {
    ...
    void payment_confirm_success_improved() {
        // given
    ...
    void payment_confirm_order_not_found() {
        // given
        when(paymentTransactionService.getOrderOrThrow(any(OrderId.class)))
    ...
    void payment_confirm_payment_status_failed() {
        String lockPrefix = "auction-lock:";
    ...
    void payment_confirm_invalid_amount() {
        // given
